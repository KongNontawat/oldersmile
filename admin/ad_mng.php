                            ...
                            <table class="table table-hover align-middle">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <a href="ad_proc/ad_allow_proc.php?id=<?php echo $row['ad_id'];?>&point=<?php echo $row['ad_point'];?>&user_id=<?php echo $row['user_id'];?>" class="btn btn-success px-2 btn-sm"><img src="../icon/check.png" alt=""> อนุมัติ</a>
