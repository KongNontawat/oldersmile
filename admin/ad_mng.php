                            ...
                            <table class="table table-hover align-middle">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <a href="ad_proc/ad_allow_proc.php?id=<?php echo $row['ad_id'];?>&point=<?php echo $row['ad_point'];?>&user_id=<?php echo $row['user_id'];?>" class="btn btn-success px-4 btn-sm"><img src="../icon/check.png" alt=""> อนุมัติ</a>
                                            <a onclick="return confirm('คุณแน่ใจ หรือไม่ ว่าจะไม่อนุมัติ')" href="ad_proc/ad_cancel_proc.php?id=<?php echo $row['ad_id'];?>" class="btn btn-danger btn-sm"><img src="../icon/cancel.png" style="width: 13px!important; height:13px!important;" alt=""> ไม่อนุมัติ</a>
                                        </td>
                                    </tr>
                                    <?php endforeach;?>
                                </tbody>
