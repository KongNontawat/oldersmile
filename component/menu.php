<div class="active-menu">
    ...
    <a href="category.php" class="rounded-4 px-1 py-2 mb-1 d-flex align-items-center category"><img src="icon/pin.png" class="me-2" alt="" width="30" height="30"><p>เรื่องที่สนใจ</p></a>
