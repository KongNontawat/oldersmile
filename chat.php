                ...
                <div class="card shadow-sm mb-3" style="min-height:450px">
                    <div class="card-header bg-white d-flex justify-content-between align-items-center">
                     <a href="user_profile.php?id=<?php echo $row['user_id'] ?>" class="d-flex align-items-center">
                            <img src="img/<?php echo $row['user_image'] ?>" alt="" class="rounded-circle me-2 border" width="40" height="40">
                    ...
                    <div class="card-body" id="show_message" style="max-height:450px;overflow-y:scroll;">
                ...
                $.get('chat_proc/chat_get.php?id=<?php echo $_GET['id'] ?>',function(data,status) {
                    ...
                    $.each($.parseJSON(data),function(i,val) {
                        ...
                        if(val.sender == <?php echo $my_id ?>) {
                            ...
                            <div class="flex-grow-0" style="max-width:350px;">
                                <p class="rounded-3 bg-primary p-1 px-2">${val.message}</p>
                            ...
                            <div class="flex-grow-0 ms-2" style="max-width:350px;">
                                <p class="rounded-3 p-1 px-2" style="background:#e0e0e0;">${val.message}</p>
